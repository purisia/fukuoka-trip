...
const D = [
  ...
  {
    key:"d4", title:"키스이마루 조식 & 오호리 & 귀국", theme:"🐟 해선 아침 → 안개정원 → 공항",
    emoji:"🐟", color:"#C8874A", date:"Day 4 · 3/8(일)",
    budget:"아침(키스이마루) ¥690~1,690 · 불랑제 ¥500~ · 교통 ¥520 · 점심 ¥1,000~",
    items:[
      {t:"07:00",a:"기상 + 체크아웃 준비",icon:"🏠",type:"stay",dur:"30분"},
      {t:"07:30",a:"키스이마루 해선 아침 🐟",icon:"🐟",type:"food",dur:"60분",
        spot:{name:"키스이마루 하카타1번가점",jp:"博多の海鮮料理 喜水丸 博多1番街店",lat:33.5904,lng:130.4200,
          r:4.0,rc:3200,h:"조식 07:30~10:00 / 통상 10:30~23:00",tel:"092-409-4114",price:"¥690~1,690"},
        sub:"숙소에서 도보 4분 — 하카타역 B1F 1번가",
        menu:[{n:"🥇 아침 사시미 정식",p:"¥990",d:"본일의 사시미 3종+명란 무한리필+밥·된장국 리필 무료"},{n:"고마사바 정식",p:"¥1,690",d:"생고등어 깨소스! 명란 무한리필 ⭐"},{n:"아침 해선 타마토로동 정식",p:"¥1,390~",d:"해산물+계란+토로로 덮밥"},{n:"명란 무한리필 아침 정식",p:"¥690~",d:"가성비 최고! 납두/소금고등어 선택"}],
        notes:["정식·돈부리 주문 시 명란 무한리필! 🎉","밥·된장국 리필 무료","예약 없이 워크인 OK — 일찍 가면 대기 적음","⚠️ 조식 10:00 마감 · 혼잡 시 조기 마감 주의","하카타역 직결 — 짐 보관·이동 편리"]},
      {t:"08:45",a:"하카타역 → 오호리 공원",icon:"🚇",type:"move",sub:"지하철 쿠코선 오호리코엔역 · 3정거장 · 10분 · ¥260"},
  ...
  },
  {
    ...
    items:[
      ...
      {t:"",a:"NEO MEGUSTA 🍶",icon:"🍶",type:"food",
        candidates:[
          ...
          {name:"아카사카 본점",jp:"NeoMegusta fukuoka standing bar",pid:"ChIJVVVZ1ymSQTURqfTFVAPBWBc",lat:33.5888,lng:130.3902,
            ...
            notes:["아카사카역 앞 — 오호리공원 가는 길목!","13시부터 오픈 — 낮술 OK","영어 메뉴 · 금연","독특한 결제: 역 이름 배정 시스템"]}],
      ...
      {t:"",a:"이시무라 만세이도 츠루노코노코 🍦",icon:"🍡",type:"food",
        spot:{name:"이시무라 만세이도 본점",jp:"石村萬盛堂 本店",lat:33.5935,lng:130.4107,
          r:4.3,rc:850,h:"10:00~19:00 (매월 제3수요 휴무)",tel:"092-291-1592",price:"¥750~1,000"},
        menu:[{n:"🥇 츠루노코노코",p:"¥750",d:"본점 한정! 마시멜로+바닐라 아이스 · 상미기한 30분 ⏱️"},{n:"츠루노코노코+센차 세트",p:"¥1,000",d:"하카타 센차와 함께"},{n:"츠루노코 (鶴乃子)",p:"¥350/2개",d:"대표 기념품 · 황미앙 마시멜로"},{n:"시오마메 다이후쿠",p:"¥150",d:"소금 콩 대복 — 간식으로 딱"}],
        notes:["⭐ 1905년 창업 — 화이트데이 발상지!","본점에서만 먹을 수 있는 '츠루노코노코' 필수","주문 후 장인이 즉석 제작 — 후와후와 식감","나카스카와바타역 도보 3분 · 쿠시다 신사 근처"]}
    ]
  }
];
